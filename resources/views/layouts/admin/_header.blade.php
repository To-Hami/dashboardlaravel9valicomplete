<!-- Navbar-->
<header class="app-header" style="background-color:#FF6162 !important;"><a class="app-header__logo"
                                                                           style="font-family: 'Cairo', 'sans-serif'; background-color:#FF6162 !important;"
                                                                           href="{{ route('admin.home') }}">@lang('site.dashboard')</a>

    <!-- Sidebar toggle button-->
    <a class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"
       style="background-color:#FF6162 !important;"></a>

    <!-- Navbar Right Menu-->
    <ul class="app-nav" style="background-color:#FF6162 !important;">
