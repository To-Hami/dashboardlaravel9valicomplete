...
Route::group([
    ...
    Route::name('admin.')->prefix('admin')->group(function () {
       ...
       //preparations  ================================================================
        Route::get('/preparations/data', 'PreparationController@data')->name('preparations.data');
        Route::get('/preparations_edit', 'PreparationController@preparationsEdit')->name('preparationsEdit');
